...
This project is a web application as frontend and backend for an App called "PerkAsm", designed for AI-powered credit card rewards optimization. It provides a dashboard interface where users can manage their credit cards, get recommendations, and chat with an AI assistant.
